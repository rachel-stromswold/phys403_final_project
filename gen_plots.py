...
for i, fname in enumerate(args.posterior_files):
    ...
    if i == 0 or args.save_all:
        ...
        plt.tight_layout()
        plt.savefig(args.output_prefix + "posterior_{}.pdf".format(i))
...
if n_obs >= 0 and n_obs_lo >= 0 and n_obs_hi >= 0:
    print('It will take {} + {} - {} detections to confine H_0 to {} km s^-1 Mpc^-1'.format(n_obs, n_obs_hi-n_obs, n_obs-n_obs_lo, args.desired_error))
