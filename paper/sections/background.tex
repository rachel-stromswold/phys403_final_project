...
The first uses low redshift measurements of standard candles (footnote explaining SC), type Ia Supernovae, in order to determine $H_0$ \editremark{[haha what]}.
...
\editremark{(not sure if we have to include):
